...
const translations: Dict = {
  en: {
    ...
    "projects.ril.title1": "RIL",
    "projects.ril.title2": "DRIVING SIM",
    "projects.ril.what": "Godot-based PC driving simulator prototype with data-driven vehicles, a generated track and a time-trial loop.",
    "projects.ril.role": "Role — Gameplay systems, vehicle simulation, telemetry and validation tooling.",
    "projects.ril.impact": "Impact — Playable racing slice with persistent best laps, HUD, checkpoints and testable simulation contracts.",
    "projects.ril.desc": "Godot project covering bootstrap flow, technical circuit generation, raycast wheel contacts, tire and load telemetry, drivetrain, assists, time-trial persistence and a simulator environment used to train a reinforcement-learning driving model.",
    "projects.ril.tags": "GODOT | C# | GDSCRIPT | SIMULATION",
    "projects.ril.cta": "Open GitHub →",
    "projects.ril.reelRole": "Game systems - Driving simulator",
    "projects.ner.title1": "NER",
    "projects.ner.title2": "KIND",
    "projects.ner.what": "Supervised Named Entity Recognition system on the EVALITA 2023 KIND dataset.",
    "projects.ner.role": "Role — ML pipeline, model architecture, evaluation and experiment design.",
    "projects.ner.impact": "Impact — Reproducible experiments across domains with generalist and Wikinews-specific models.",
    "projects.ner.desc": "Python training pipeline for CharCNN + BiLSTM + CRF models, preprocessing ablations, embedding comparison, BIO validation and NERMuD/seqeval evaluation outputs.",
    "projects.ner.tags": "PYTHON | NLP | BILSTM-CRF | KIND",
    "projects.ner.cta": "Open GitHub →",
    "projects.ner.reelRole": "Machine Learning - NLP",
  ...
  it: {
    ...
    "projects.ril.title1": "RIL",
    "projects.ril.title2": "DRIVING SIM",
    "projects.ril.what": "Simulatore di guida PC in Godot con veicoli data-driven, tracciato generato e loop time-trial.",
    "projects.ril.role": "Ruolo — Gameplay systems, simulazione veicolo, telemetria e strumenti di validazione.",
    "projects.ril.impact": "Impatto — Vertical slice guidabile con best lap persistenti, HUD, checkpoint e contratti simulativi testabili.",
    "projects.ril.desc": "Progetto Godot con bootstrap, generazione del circuito tecnico, contatti ruota via raycast, telemetria gomme/carichi, drivetrain, assist, persistenza time-trial e ambiente simulativo usato per addestrare un modello di reinforcement learning alla guida.",
    "projects.ril.tags": "GODOT | C# | GDSCRIPT | SIMULATION",
    "projects.ril.cta": "Apri GitHub →",
    "projects.ril.reelRole": "Game systems - Simulatore di guida",
    "projects.ner.title1": "NER",
    "projects.ner.title2": "KIND",
    "projects.ner.what": "Sistema supervisionato di Named Entity Recognition sul dataset KIND di EVALITA 2023.",
    "projects.ner.role": "Ruolo — Pipeline ML, architettura modello, valutazione e disegno sperimentale.",
    "projects.ner.impact": "Impatto — Esperimenti riproducibili su piu domini con modelli generalisti e specifici Wikinews.",
    "projects.ner.desc": "Pipeline Python per modelli CharCNN + BiLSTM + CRF, ablation di preprocessing, confronto embedding, validazione BIO e metriche NERMuD/seqeval.",
    "projects.ner.tags": "PYTHON | NLP | BILSTM-CRF | KIND",
    "projects.ner.cta": "Apri GitHub →",
    "projects.ner.reelRole": "Machine Learning - NLP",
